...
public abstract class EdgeConvertCreateDDL {
   ...
   protected EdgeTable[] tables; //master copy of com.example.finalproject422.EdgeTable objects
   protected EdgeField[] fields; //master copy of com.example.finalproject422.EdgeField objects
   ...
   public EdgeConvertCreateDDL(EdgeTable[] tables, EdgeField[] fields) {
      ...
      this.fields = fields;
      initialize();
   } //com.example.finalproject422.EdgeConvertCreateDDL(com.example.finalproject422.EdgeTable[], com.example.finalproject422.EdgeField[])
   ...
   } //com.example.finalproject422.EdgeConvertCreateDDL()
