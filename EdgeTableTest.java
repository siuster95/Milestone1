...
public class EdgeTableTest{
  ...
  public void testGetNumFigure(){
    int expected = 5;
    assertEquals("getNumFigure is set 5",expected,testET.getNumFigure());
  }
  @Test
  public void testGetname(){
    String expected = "Hello";
    assertEquals("getName is set Hello",expected,testET.getName());
  }
 ...
 public void testGetNativeFieldsArray(){
      ...
      expected[0] = 10;
      assertEquals("NativeFields sets to  1",expected[0], testET.getNativeFieldsArray()[0]);
 }
  ...
  public void testGetRelatedTablesArray(){
    ...
    assertEquals("Set GetRelatedTable array to 1",expected[0],testET.getRelatedTablesArray()[0]);
  ...
  public void testGetRelatedFieldsArray(){
    ...
    int[] expected = new int[1];
    expected[0] = 5;
    assertEquals("Set field to 0",expected[0],testET.getRelatedFieldsArray()[0]);
  ...
  assertEquals("Test: Hello",sb.toString(),testET.toString());
