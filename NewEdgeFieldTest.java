...
public class NewEdgeFieldTest{
	...
	String input = System.getProperty("EdgeFieldTestParams");
	String stArray[] = input.split("\\|");
	NumFig = Integer.parseInt(stArray[0]);
	Name = stArray[1];
        testObj = new EdgeField(input);
        //runner();
    }
    ...
    */
	...
	public void testGetNumFigure() {
		assertEquals("num figure was initialized to "+ NumFig + "so it should be" + NumFig,NumFig,testObj.getNumFigure());
    }
    @Test
	public void testGetName() {
		assertEquals("name was initialized to " + Name + " so it should be" + Name, Name,testObj.getName());
    }
    @Test
