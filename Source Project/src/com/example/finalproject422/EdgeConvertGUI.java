...
public class EdgeConvertGUI {
   ...
   private static JFileChooser jfcEdge, jfcGetClass, jfcOutputDir, jfcXML;
   ...
   private EdgeTable[] tables; //master copy of com.example.finalproject422.EdgeTable objects
   private EdgeField[] fields; //master copy of com.example.finalproject422.EdgeField objects
   ...
   static JMenuItem jmiDTOpenEdge, jmiDTOpenSave, jmiDTSave, jmiDTSaveAs, jmiDTExit, jmiDTOptionsOutputLocation, jmiDTOptionsShowProducts, jmiDTHelpAbout, jmiDTOpenXML;
   ...
   static JMenuItem jmiDROpenEdge, jmiDROpenSave, jmiDRSave, jmiDRSaveAs, jmiDRExit, jmiDROptionsOutputLocation, jmiDROptionsShowProducts, jmiDRHelpAbout, jmiDROpenXML;
   ...
   public EdgeConvertGUI() {
      ...
      this.showGUI();
   } // com.example.finalproject422.EdgeConvertGUI.com.example.finalproject422.EdgeConvertGUI()
   ...
   public void createDTScreen() {//create Define Tables screen
      ...
      jmiDTOpenXML.setMnemonic(KeyEvent.VK_G);
   ...
   public void createDRScreen() {
      ...
      jmiDROpenXML.setMnemonic(KeyEvent.VK_G);
   ...
   private void getOutputClasses() {
      ...
      try {
         ...
         System.out.println(resultFiles[i].getName());
            ...
            if (resultClass.getSuperclass().getName().equals("com.example.finalproject422.EdgeConvertCreateDDL")) { //only interested in classes that extend com.example.finalproject422.EdgeConvertCreateDDL
   ...
   class CreateDDLButtonListener implements ActionListener {
      public void actionPerformed(ActionEvent ae) {
         ...
         getOutputClasses(); //in case outputDir was set before a file was loaded and com.example.finalproject422.EdgeTable/com.example.finalproject422.EdgeField objects created
...
} // com.example.finalproject422.EdgeConvertGUI
