...
public class EdgeConvertGUI {
   ...
   static JMenuItem jmiDTOpenEdge, jmiDTOpenSave, jmiDTSave, jmiDTSaveAs, jmiDTExit, jmiDTOptionsOutputLocation, jmiDTOptionsShowProducts, jmiDTHelpAbout, jmiDTHelpSystem;
   ...
   static JMenuItem jmiDROpenEdge, jmiDROpenSave, jmiDRSave, jmiDRSaveAs, jmiDRExit, jmiDROptionsOutputLocation, jmiDROptionsShowProducts, jmiDRHelpAbout, jmiDRHelpSystem;
   ...
   public void createDTScreen() {//create Define Tables screen
      ...
      jmiDTHelpSystem = new JMenuItem("System");
      jmiDTHelpSystem.setMnemonic(KeyEvent.VK_A);
   ...
   public void createDRScreen() {
      ...
      jmiDRHelpSystem = new JMenuItem("System");
      jmiDRHelpSystem.setMnemonic(KeyEvent.VK_A);
      jmiDRHelpSystem.addActionListener(menuListener);
      jmDRHelp.add(jmiDRHelpAbout);
      jmDRHelp.add(jmiDRHelpSystem);
   ...
   class EdgeMenuListener implements ActionListener {
      public void actionPerformed(ActionEvent ae) {
         ...
         if((ae.getSource() == jmiDTHelpSystem) || (ae.getSource() == jmiDRHelpSystem)){
